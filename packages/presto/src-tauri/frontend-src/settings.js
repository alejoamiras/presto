...
function renderAutostartStatus(st) {
  ...
  if (st.unreadable) {
    ...
    if (st.canRepairNow) {
      ...
      message = "Start on Login needs repair. Reopen Presto from its new location.";
    }
    ...
    message =
      "Start on Login points to another copy of Presto. Turn it off and on to use this one.";
  }
